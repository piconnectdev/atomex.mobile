...
namespace atomex.ViewModels
{
    public class CreateNewWalletViewModel : BaseViewModel
    {
        ...
        private async Task ConnectToWallet()
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                        _navigationService?.ShowAlert(AppResources.Error, AppResources.CreateWalletError,
        ...
        public ICommand CreateStoragePasswordPageCommand => _createStoragePasswordPageCommand ??=
        ...
        public ICommand DerivedPswdChangedCommand => _derivedPswdChangedCommand ??=
            ReactiveCommand.Create<string>((value) => SetPassword(PasswordType.DerivedPassword, value));

        private ICommand _derivedPswdConfirmationChangedCommand;

        public ICommand DerivedPswdConfirmationChangedCommand => _derivedPswdConfirmationChangedCommand ??=
            new Command<string>((value) => SetPassword(PasswordType.DerivedPasswordConfirmation, value));

        private ICommand _storagePswdChangedCommand;

        public ICommand StoragePswdChangedCommand => _storagePswdChangedCommand ??=
            ReactiveCommand.Create<string>((value) => SetPassword(PasswordType.StoragePassword, value));

        private ICommand _storagePswdConfirmationChangedCommand;

        public ICommand StoragePswdConfirmationChangedCommand => _storagePswdConfirmationChangedCommand ??=
            ReactiveCommand.Create<string>((value) => SetPassword(PasswordType.StoragePasswordConfirmation, value));
        ...
        public ICommand UseDerivedPswdInfoCommand => _useDerivedPswdInfoCommand ??= ReactiveCommand.Create(() =>
            _navigationService?.ShowAlert(string.Empty, AppResources.DerivedPasswordDescriptionText,
                AppResources.AcceptButton));

        private ICommand _addWordToVerificationCommand;

        public ICommand AddWordToVerificationCommand => _addWordToVerificationCommand ??=
        ...
        public ICommand DeleteWordFromVerificationCommand => _deleteWordFromVerificationCommand ??=
            ReactiveCommand.Create<string>((word) => UpdateMnemonicCollections(word, false));

        private ICommand _verificateDerivedPswdCommand;

        public ICommand VerificateDerivedPswdCommand =>
            _verificateDerivedPswdCommand ??= new Command(() => VerificateDerivedPassword());
        ...
        public ICommand CreateWalletCommand => _createWalletCommand ??=
            ReactiveCommand.CreateFromTask(async () => await ConnectToWallet());
        ...
        public ICommand CancelCommand =>
            _cancelCommand ??= ReactiveCommand.Create(() => _navigationService?.ClosePage());
